...
if __name__ == "__main__":
    """
    This script shows how to control UR5's arm and gripper in Gazebo
    Launch this first:
    roslaunch bimur_bringup bimur_right_robot_gazebo_1_moveit.launch
    """

    rospy.init_node('gazebo_moveit_example_1', anonymous=True)
    ...
    # How to control the gripper using moveit:
    # Close
    grp_group.set_joint_value_target([0.8039005131791948, -0.8039005131791948, 0.8039005131791948, 0.8039005131791948,
                                      -0.8039005131791948, 0.8039005131791948])
    ...
    # Open
    # grp_group.set_joint_value_target([9.800441184282249e-05, -9.800441184282249e-05, 9.800441184282249e-05,
    #                                   9.800441184282249e-05, -9.800441184282249e-05, 9.800441184282249e-05])
